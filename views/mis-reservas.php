...
<html>
	<head>
		...
		<link href="css/estilos-mis-reservas.css" rel="stylesheet" type="text/css" />
		...
		<main>
			<section>
				<article>
					<div class="catorce">
						<h1>Mis reservas</h1>
						<img src="imagenes/veinte.jpg" alt="Imagen Gaming" width="250px" >
						<p>Seleccione fecha inicio y fecha fin para ver sus reservas.</p>
                        <form method="post">
                            ...
                            <input type="submit" name="misreservas" value="Mis reservas" class="once">
                        </form>
						<?php
							if(isset($_POST['misreservas'])){
            					...
            					elseif($_POST['desde']>$_POST['hasta'])
									...
									if(mysqli_num_rows($fila)==0)
            							echo "<span class=doce>Entre ".date("d/m/Y", strtotime($_POST['desde']))." y ".date("d/m/Y", strtotime($_POST['hasta']))." no tiene reservas.</span>";
        							else{
										echo
										"<div class=trece>
										<table>
