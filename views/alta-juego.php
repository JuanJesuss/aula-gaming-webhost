...
<html>
	<head>
		...
		<link href="css/estilos-alta-juego.css" rel="stylesheet" type="text/css" />
	...
	<body>
		...
		<nav>
			<ul class="nueve">
				...
				<li class="altajuego"><a href="controller-alta-juego.php">Alta juego</a></li>
			</ul>
		</nav>
		<main>
			<section>
				<article>
					<div>
						<h1>Alta juego</h1>
						<img src="imagenes/veintitres.jpg" alt="Imagen Gaming" width="250px" >
                        <form method="post">
							<label for="nombre-juego">Introduzca el nombre del juego a dar de alta:</label>
							<input type="text" name="nombrejuego" /><br/>
                            <input type="submit" name="altajuego" value="Alta juego" class="diez">
                        </form>
					</div>
				</article>
			</section>
