...
<html>
	<head>
		...
		<link href="css/estilos-reservas.css" rel="stylesheet" type="text/css" />
	...
	<body>
		...
		<main>
			<section>
				<article>
					<div class="catorce">
						<h1>Otras reservas</h1>
						<p>Seleccione fecha inicio, fecha fin y luego pulse 'Ver reservas' para ver las reservas que tienen los usuarios entre las fechas que ha seleccionado.</p>
						<img src="imagenes/dos.jpg" alt="Imagen Gaming" width="300px" >
                        <form method="post">
                            ...
                            <input type="submit" name="reservas" value="Ver reservas" class="once">
                        </form>
						<?php
							if(isset($_POST['reservas'])){
								...
								elseif($_POST['desde']>$_POST['hasta'])
									...
									if(mysqli_num_rows($fila)==0)
										echo "<span class=doce>Entre ".date("d/m/Y", strtotime($_POST['desde']))." y ".date("d/m/Y", strtotime($_POST['hasta']))." no hay reservas.</span>";
									else{
										echo
										"<div class=trece>
										<table>
